...
admin access that allows him to add, remove or update the Tours Page. We used bcrypt, to generate a hashed password and JWT to create a token to provide to the user
